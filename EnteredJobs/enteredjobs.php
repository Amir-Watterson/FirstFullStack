...
<body>
    ...
    <div class="text-container">
        <p>
            ...
            Более подробно про работу можно узнать <a href="/InfoAboutJobs-Idea/info.html">здесь</a>.
        </p>
    </div>
    ...
    <div class="form-container">
        <form method="post">
            ...
            <textarea placeholder="Опишите талант" name="talant"></textarea>
            ...
            if (isset($_POST['ok'])) {
                ...
                if (empty($name) || empty($surname) || empty($phone) || empty($city) || empty($addres) || empty($talant)) {
                    echo '<p class="error-message">Пожалуйста, заполните все поля формы.</p>';
                }else {
                    $info = [
                        'name' => $name,
                        'surname' => $surname,
                    ...
                    echo '<script>window.location.replace("checkjob.php");</script>';
;
                }
            }
